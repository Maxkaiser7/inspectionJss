...
export default function CameraPathStartBlock({ initialData, onChange }) {
  ...
  const startPoints = ["WC", "Citerne d’eau de pluie", "Regard", "Baignoire", "Chambre de visite ACCESSIBLE", "Évier", "Descente pluviale", "Machine à laver", "Douche", "Siphon disconnecteur", "Sterput", "Fosse septique ACCESSIBLE", "DEGRAISSEUR ACCESSIBLE", "Avaloirs", "Autre"];
  ...
  const SelectButton = ({ selected, label, onPress }) => (
    <TouchableOpacity
      onPress={onPress}
      style={{ padding: 8, backgroundColor: selected ? "#007AFF20" : "#f0f0f0", borderRadius: 6, margin: 4, flexGrow: 1 }}
    >
